...
function notify(type, title_name,title_info,notification_about,media_name,message,image,profile,media){
    ...
    var toast_container          = $('.toast-container'),
        toast_type               = type,
        toast_icon               = null,
        toast_title_name         = title_name,
        toast_title_info         = title_info,
        toast_notification_about = notification_about,
        toast_media_name         = media_name,
        toast_message            = message,
        toast_profile            = profile,
        toast_media              = media
    ...
    switch(toast_type){
        ...
        case 'custom':     
                           if(image){
                            toast_icon = `<img src="data:image/png;base64,${image}" class="img-toast">`;break;
                           }
                           else{
                               toast_icon = '<img src="/profileAssets/images/male.jpg" class="img-toast">';break;
                           }
    ...
    $('<div>',{
        ...
        .html(`<div class="toast-content"><div class="toast-icon">${toast_icon}</div><div class="toast-body"><strong><a class="toast-link" href="${toast_profile}">${toast_title_name} </a> ${toast_title_info}  <br> ${toast_notification_about} <a class="toast-link" href="${toast_media}">${toast_media_name}</a> </strong><div class="toast-message"> ${toast_message} </div></div></div><button class="close" type="button" data-dismiss="toast" aria-label="Close"><span aria-hidden="true">${toast_btn_close_svg} </span></button>`)
